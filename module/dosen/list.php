      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="add.php"><button type="button" class="btn btn-success"><span class="fa fa-plus"></span> Input Dosen</button></a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $listDosen=$dosen->getList();
                    while($row=$listDosen->fetch(PDO::FETCH_OBJ)) {
                  ?>
                      <tr>
                        ...
                        <td width="15%" class="text-center"><?php echo $row->nik ?></td>
                ...
                <?php
                  if(isset($_GET['delete_id'])) {
                    $dosen->deleteData($_GET['delete_id']);
                  ?>
                      <script>
