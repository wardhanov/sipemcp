      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
             <?php
              $dataKelas=$kelas->getListKelas($_GET['id'])->fetch(PDO::FETCH_OBJ);
              $id=$dataKelas->id;
              $kode=$dataKelas->kode;
            ?>
            <form role="form" action="edit.php?id=<?php echo $id ?>" method="post">
              <div class="box-body">
                <input type="hidden" name="id" value="<?php echo $id ?>" class="form-control" placeholder="Kode kelas" required>
                <div class="form-group">
                  <label>Kode</label>
                  <input type="text" name="kode" value="<?php echo $kode ?>" class="form-control" placeholder="Kode kelas" required>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <button type="submit" name="simpan" value="edit" class="btn btn-success"><span class="fa fa-save"></span> Simpan</button>
