      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <?php
              $dataMahasiswa=$mahasiswa->getListMahasiswa($_GET['id'])->fetch(PDO::FETCH_OBJ);
              $id=$dataMahasiswa->id;
            ...
            <form role="form" action="edit.php?id=<?php echo $id ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>NIM</label>
                  <input type="text" name="nim" value="<?php echo $nim ?>" class="form-control" placeholder="Nomor induk mahasiswa" required>
                </div>
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" name="nama" value="<?php echo $nama ?>" class="form-control" placeholder="Nama lengkap mahasiswa" required>
                </div>
                <div class="form-group">
                  <label>Semester</label>
                  <input type="number" name="semester" value="<?php echo $semester ?>" class="form-control" placeholder="Semester saat ini" required>
                </div>
              </div>
              <!-- /.box-body -->
