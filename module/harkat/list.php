      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="add.php"><button type="button" class="btn btn-success"><span class="fa fa-plus"></span> Input Harkat</button></a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center">Harkat</th>
                </tr>
                </thead>
                <tbody>
                  <?php
                    $listHarkat=$harkat->getList();
                    while($row=$listHarkat->fetch(PDO::FETCH_OBJ)) {
                  ?>
                      <tr>
                        ...
                        <td class="text-center"><?php echo $row->huruf ?></td>
                        <td class="text-center"><?php echo $row->harkat ?></td>
                      </tr>
                  <?php
                    }
                  ?>
                ...
                <?php
                  if(isset($_GET['delete_id'])) {
                    $harkat->deleteData($_GET['delete_id']);
                  ?>
                      <script>
