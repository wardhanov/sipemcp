      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="add.php"><button type="button" class="btn btn-success"><span class="fa fa-plus"></span> Input Kelas</button></a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $listKelas=$kelas->getList();
                    while($row=$listKelas->fetch(PDO::FETCH_OBJ)) {
                  ?>
                      <tr>
                ...
                <?php
                  if(isset($_GET['delete_id'])) {
                    $kelas->deleteData($_GET['delete_id']);
                  ?>
                      <script>
