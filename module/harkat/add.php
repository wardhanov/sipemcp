            ...
            <form role="form" action="add.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label>Huruf</label>
                  <input type="text" name="huruf" class="form-control" placeholder="Nilai dalam huruf" required>
                </div>
                <div class="form-group">
                  <label>Harkat</label>
                  <input type="number" name="harkat" step="0.01" class="form-control" placeholder="Nilai dalam angka" required>
                </div>
              </div>
              <!-- /.box-body -->
