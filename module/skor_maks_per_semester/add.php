          ...
          <div class="box box-primary">
            ...
            <form role="form" action="add.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>CPL</label>
                  <input type="text" name="cpl" class="form-control" placeholder="Capaian Pembelajaran Per Semester" required>
                </div>
                <div class="form-group">
                  <label>Skor Maksimum</label>
                  <input type="text" name="skor_maks" class="form-control" placeholder="Skor Maksimum" required>
                </div>
              </div>
              <!-- /.box-body -->
            ...
            <?php
              if(isset($_POST['simpan'])) {
                ...
                $skor_maks_per_semester->add($params);
            ?>
                <script>
