...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Master Data Skor Maksimal Per Semester
      </h1>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="add.php"><button type="button" class="btn btn-success"><span class="fa fa-plus"></span> Input Skor</button></a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $listSkorMaksPerSemester=$skor_maks_per_semester->getList();
                    while($row=$listSkorMaksPerSemester->fetch(PDO::FETCH_OBJ)) {
                  ?>
                      <tr>
                        ...
                        <td class="text-center">Semester <?php echo $row->semester ?></td>
                        <td class="text-center">CPL <?php echo $row->cpl ?></td>
                        <td class="text-center"><?php echo $row->skor_maks ?></td>
                      </tr>
                  <?php
                    }
                  ?>
                ...
                <?php
                  if(isset($_GET['delete_id'])) {
                    $skor_maks_per_semester->deleteData($_GET['delete_id']);
                  ?>
                      <script>
