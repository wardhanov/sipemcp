      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="add.php"><button type="button" class="btn btn-success"><span class="fa fa-plus"></span> Input Mahasiswa</button></a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    ...
                    while($row=$listMahasiswa->fetch(PDO::FETCH_OBJ)) {
                  ?>
                      <tr>
                        ...
                        <td width="15%" class="text-center"><?php echo $row->nim ?></td>
                        <td><?php echo $row->nama ?></td>
                        <td width="10%" class="text-center"><?php echo $row->semester ?></td>
                      </tr>
                  <?php
                    }
                  ?>
                ...
                <?php
                  if(isset($_GET['delete_id'])) {
                    $mahasiswa->deleteData($_GET['delete_id']);
                  ?>
                      <script>
